...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mysqli_stmt_execute($stmt)) $msg = 'Updated';
...
<body>
  ...
  <form method="post" enctype="multipart/form-data">
    ...
    <label>Short description: <input name="short_description" value="<?php echo htmlspecialchars($product['short_description']); ?>"></label><br>
    <label>Description: <textarea name="description"><?php echo htmlspecialchars($product['description']); ?></textarea></label><br>
    <label>Price: <input name="price" type="number" step="0.01" required value="<?php echo htmlspecialchars($product['price']); ?>"></label><br>
    <label>Stock: <input name="stock" type="number" value="<?php echo htmlspecialchars($product['stock']); ?>"></label><br>
    <label>Category:
